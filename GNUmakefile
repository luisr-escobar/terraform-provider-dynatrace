...
testacc: fmtcheck
	mkdir -p ~/.terraform.d/plugins/dynatrace.com/com/dynatrace/1.0.2/$(OS_ARCH)
	go clean -cache
	go build -o ~/.terraform.d/plugins/dynatrace.com/com/dynatrace/1.0.2/$(OS_ARCH)/terraform-provider-dynatrace_1.0.2_$(OS_ARCH)
